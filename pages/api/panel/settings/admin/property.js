        ...
        try {
            ...
            if (req.method == 'POST') {
                try {
                    ...
                    var updateFields = {
                        'admin.property.reviewsAllowed': fields.reviewsAllowed,
                        'admin.property.onlyUsersWithBookingAllowed': fields.onlyUsersWithBookingAllowed,
                    }
                    // Multi vendor logics >>>>>>>>>>>>>>
                    ...
                    if (settings.tnit.multiVendorAllowed) {
                        ...
                        updateFields['admin.property.autoVerifyVilla'] = fields.autoVerifyVilla;
                        updateFields['admin.property.autoVerifyHotel'] = fields.autoVerifyHotel;
                        updateFields['admin.property.letOwnerManageReviews'] = fields.letOwnerManageReviews;
                    }
                    // Update setting >>>>>>>>>>>>>>
