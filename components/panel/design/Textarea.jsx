...
const Textarea = ({ label, name, type, value, onChange, onKeyDown, onKeyUp, placeholder, required, className, labelClassName, inputClassName, variant, icon, defaultValue, cols, rows, register, validationOptions, optional, maxLength }) => {
                ...
                <>
                    <div className={className}>
                        ...
                        <div className="flex items-center">
                            ...
                            <textarea maxLength={maxLength} type={type} value={value} defaultValue={defaultValue} cols={cols} rows={rows} onChange={onChange} onKeyUp={onKeyUp} onKeyDown={onKeyDown} {...registerValue} id={name} name={name} className={twMerge(inputClassNames, inputClassName)} placeholder={placeholder} required={required} />
