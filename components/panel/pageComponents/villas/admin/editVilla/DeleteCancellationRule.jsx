...
const DeleteCancellationRule = ({ deleteMessage, setDeleteMessage, deleteCancellationRuleDrawer, setDeleteCancellationRuleDrawer, deleteCancellationRuleId, deleteCancellationRule, reFetchCancellationRules, setGlobalMessage, villaId }) => {
    ...
    const deleteCancellationRuleSubmit = async () => {
        ...
        const response = await fetch(`/api/panel/villas/admin/${villaId}/cancellation/rules/delete`, {
            method: "POST",
            headers: {
