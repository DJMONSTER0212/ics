...
const EditCancellationRule = ({ editMessage, setEditMessage, editCancellationRuleDrawer, setEditCancellationRuleDrawer, reFetchCancellationRules, settings, setGlobalMessage, editCancellationRuleId, villaId }) => {
    // For drawer >>>>>>>>>>>>>>>>>
    ...
    const editFormSubmit = async (data) => {
        ...
        const response = await fetch(`/api/panel/villas/admin/${villaId}/cancellation/rules/${data._id}`, {
            method: "POST",
            body: formData
        })
    ...
    const editFetch = useCallback(async (id) => {
        ...
        const response = await fetch(`/api/panel/villas/admin/${villaId}/cancellation/rules/${id}`, {
            headers: {
    ...
    }, [clearErrors, reset, setEditCancellationRuleDrawer, setEditMessage, setValue, setGlobalMessage, villaId])
