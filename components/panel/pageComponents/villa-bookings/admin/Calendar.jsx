...
const Calendar = forwardRef(({ checkIn, checkOut, setSelectedDates, settings }, ref) => {
    // Calendar info >>>>>>>>>>>>>>>>>>
    ...
    // Selected dates >>>>>>>>>>>>>>>>>>
    const [inDate, setInDate] = useState(checkIn && dayjs(checkIn) || null);
    const [outDate, setOutDate] = useState(checkOut && dayjs(checkOut) || null);
    ...
    return (
        <>
            <p className='text-base font-medium text-black-500 dark:text-white mt-5'>Stay details</p>
