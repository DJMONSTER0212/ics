...
const Guests = ({ petAllowed, minGuest, maxGuest, maxChild, setGuests, guests }) => {
    // Guest menu states >>>>>>>>>>>>>>>>
    ...
    // Guest data >>>>>>>>>>>>>>>>
    const [adults, setAdults] = useState(guests?.adults || minGuest);
    const [childs, setChilds] = useState(guests?.childs || 0);
