...
import AddCancellationRule from '@/components/panel/pageComponents/setting/admin/AddCancellationRule';
import EditCancellationRule from '@/components/panel/pageComponents/setting/admin/EditCancellationRule';
import DeleteCancellationRule from '@/components/panel/pageComponents/setting/admin/DeleteCancellationRule';
import Empty from '@/components/panel/design/Empty'

const CancellationRules = ({ globalMessage, setGlobalMessage }) => {
    ...
    useEffect(() => {
        const fetchCancellationRules = async () => {
            ...
            if (responseData.data) {
                setCancellationRules(responseData.data.admin.cancellation.cancellationRules)  // Set data in cancellation rule
            } else {
